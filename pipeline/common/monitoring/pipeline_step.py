...
def upd_step(conection_db, id_exec, fim, status, camada, entidade=None, id_arquivo=None, linhas_lidas=None,
             linhas_gravadas=None, duracao=None):
    ...
    valores = (id_arquivo, linhas_lidas, linhas_gravadas, fim, duracao, status, id_exec, camada, entidade)
